...
/**
 * Model de Level (Nível de Acesso)
 * 
 * @package App\Models
 */
class Level extends Model
{
    ...
    /**
     * Pesquisa níveis por nome, tradução ou descrição
     * 
     * Realiza busca com LIKE em múltiplos campos permitindo
     * encontrar níveis mesmo com busca parcial.
     * Retorna apenas níveis não deletados.
     * 
     ...
     * @return array Array de níveis que correspondem à busca
     * 
     * @example
     * // Buscar níveis que contenham "admin"
     * $levels = $levelModel->search('admin', 10, 0);
     */
    ...
    /**
     * Busca todos os níveis deletados (lixeira)
     * 
     * Retorna níveis que foram marcados como deletados (soft delete).
     ...
     * 
     * @return array Array de níveis deletados
     * 
     * @example
     * $deletedLevels = $levelModel->trash();
     */
    ...
    /**
     * Restaura um nível deletado
     * 
     * Remove a marcação de exclusão (deleted_at = NULL) permitindo
     * que o nível volte a aparecer nas listagens e possa ser
     * utilizado novamente no sistema.
     * 
     * @param int $id ID do nível a ser restaurado
    ...
    /**
     * Deleta um nível permanentemente do banco de dados
     * 
     * ATENÇÃO: Esta operação é IRREVERSÍVEL!
     * Remove completamente o registro do banco de dados.
     * Use apenas para níveis que realmente não serão mais necessários.
     * 
     * @param int $id ID do nível a ser deletado permanentemente
